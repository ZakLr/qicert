...
| **C++ port** | DEFER to Phase 2 | Justified only by latency numbers we don't have; Python passes 100 ms on measured paths. One sentence in the report ("a C++ contraction kernel is the Phase-2 latency lever") covers the credibility question without carrying unmaintained code. |
