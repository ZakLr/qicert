# qicert: Certified Compression of Vision-Language-Action Models
...
**Website:** https://qicert.vercel.app

**Documentation:** https://qicert.vercel.app/docs

Supporting material in this folder: [resource-declaration.md](resource-declaration.md) (compute accounting), [licenses.md](licenses.md) (models, datasets, dependencies). The full codebase, experiment artifacts, and test suite live at https://github.com/ZakLr/qicert.

Contact: zakaria@aiqcommunity.org
