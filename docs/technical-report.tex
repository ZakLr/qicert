...
batch 2 on local RTX 5060) has been running and the first seed's fine-tuned
accuracy is converging near 0.44 (Wilson 95\%, streamed over 6{,}496
...
1--3 complete. No number in this revision is fabricated; each final table row
is regenerable from \texttt{results/N1v2/\{run_id\}/run.json} + the ledger.
